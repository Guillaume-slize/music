...
all.disclinks <- paste ("https://www.discogs.com/search/?layout=sm&page=",seq(0,50),"&decade=2010&year=2016", sep="")
...
all.disclinks.partly = lapply(all.disclinks [1:4], link.collector)
...
# all.tranferlinks2.partly = lapply(all.disclinks, link.collector2)
